...
export function QuestForm({ quest, onSuccess, onError }: QuestFormProps) {
    ...
    const getInputStyle = () => {
        const base = "w-full min-h-[96px] flex px-4 py-3 border-2 font-rajdhani font-bold text-base transition-colors touch-manipulation backdrop-blur-sm bg-black/50 text-foreground/90 focus:outline-none resize-none";
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
            <motion.div {...getVariants()}>
                <textarea
                    ...
                    placeholder="Saisissez votre développement..."
                    aria-label="Texte de la quête"
                    autoFocus
                />
            </motion.div>
